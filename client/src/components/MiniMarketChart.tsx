...
export default function MiniMarketChart({ priceYes }: MiniMarketChartProps) {
  ...
  const color = normalizedPrice > 0.5 ? "#10b981" : "#ef4444"; // emerald-500 or red-500
